...
void Matriz::generarMatriz(int tipo){
	switch(tipo){
		case 1:
			...
			_columnas=5;
			_tipo=1;
			_pregunta= "¿Cúal Es La Matriz Fila?"  ;
			mat1();
		break;
		case 2:
			_filas=5;
			_columnas=5;
			_tipo=2;
			_pregunta= "¿Cúal Es La Matriz Cuadrada?"  ;
			mat2();
		break;
			case 3:
			_filas=2;
			_columnas=5;
			_tipo=3;
			_pregunta= "¿Cúal Es La Matriz Rectangular?"  ;
			mat3();
		break;
		case 4:
			_filas=5;
			_columnas=5;
			_tipo=4;
			_pregunta= "¿Cúal Es La Matriz Triangular Superior?"  ;
			mat4();
		break;
		case 5:
			_filas=5;
			_columnas=5;
			_tipo=4;
			_pregunta= "¿Cúal Es La Matriz Triangular Inferior?"  ;
			mat5();
		break;
		case 6:
			_filas=5;
			_columnas=5;
			_tipo=6;
			_pregunta= "¿Cúal Es La Matriz Diagonal?"   ;
			mat6();
		break;
		case 7:
			_filas=5;
			_columnas=5;
			_tipo=7;
			_pregunta= "¿Cúal Es La Matriz Identidad?"  ;
			mat7();
		break;
	}
}
